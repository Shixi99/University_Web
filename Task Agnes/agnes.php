                ...
                <div class="container">
                    <div class="hero-inner">
                        <div class="hero-copy">
                            ...
                            <p class="hero-paragraph is-revealing">Our landing page template works for all the devices,
                                so you only have to setup it once, and get beautiful results forever.</p>
                            <p class="hero-cta is-revealing"><a class="button button-primary button-shadow"
                                    href="#">Pricing and plans</a></p>
                        </div>
                        <div class="hero-illustration is-revealing">
                            <svg width="528" height="413" viewBox="0 0 528 413" xmlns="http://www.w3.org/2000/svg">
                                ...
                                <g transform="translate(0 -1)" fill="none" fill-rule="evenodd">
                                    ...
                                    <rect fill="url(#hero-illustration-d)" x="335" y="242" width="32" height="32"
                                        rx="16" />
                                </g>
                            </svg>
                        </div>
                        ...
                        <div class="features-wrap">
                            ...
                            <?php 
                                ...
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile">Featuree</h4>
                            ...
                            <!-- <div class="feature is-revealing">
                                <div class="feature-inner">
                                    ...
                                    <h4 class="feature-title h3-mobile">Featureeee</h4>
                                    <p class="text-sm">A pseudo-Latin text used in web design, layout, and printing in
                                        place of English to emphasise design elements.</p>
                                </div>
                            </div> -->
                                    ...
                                    <div class="pricing-table-main">
                                        <div class="pricing-table-header is-revealing">
                                            ...
                                            <div class="pricing-table-price mb-32 pb-24"><span
                                                    ...
                                                    class="pricing-table-price-amount h2">27</span>/mo</div>
                                        </div>
                                ...
                                <div class="pricing-table-inner">
                                    <div class="pricing-table-main">
                                        <div class="pricing-table-header is-revealing">
                                            ...
                                            <div class="pricing-table-price mb-32 pb-24"><span
                                                    class="pricing-table-price-currency h4">$</span><span
                                                    class="pricing-table-price-amount h2">97</span>/mo</div>
                                        </div>
                                        <ul class="pricing-table-features list-reset text-xs mt-24 mb-56">
                                            <li class="is-revealing">
                                                <span class="list-icon">
                                ...
                                <div class="pricing-table-inner">
                                    <div class="pricing-table-main">
                                        <div class="pricing-table-header is-revealing">
                                            ...
                                            <div class="pricing-table-price mb-32 pb-24"><span
                                                    class="pricing-table-price-currency h4">$</span><span
                                                    class="pricing-table-price-amount h2">147</span>/mo</div>
                                        </div>
                                        <ul class="pricing-table-features list-reset text-xs mt-24 mb-56">
                                            <li class="is-revealing">
                                                <span class="list-icon">
